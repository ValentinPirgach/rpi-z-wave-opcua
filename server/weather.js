...
var fs = require('fs')
var key = '00a496e0e42040ec8ea151729180404'
  ...
  function construct_my_address_space(server) {
    ...
    function create_CityNode(city_name) {
      ...
      server.engine.addressSpace.addVariable({
        ...
        value: {
          get: function() {
            return extract_value(city_name, 'temperature')
          },
        },
      })
      server.engine.addressSpace.addVariable({
        ...
        value: {
          get: function() {
            return extract_value(city_name, 'humidity')
          },
        },
      })
      server.engine.addressSpace.addVariable({
        ...
        value: {
          get: function() {
            return extract_value(city_name, 'pressure')
          },
        },
      })
    }
